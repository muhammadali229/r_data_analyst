...
```{r}
bookings_df <- read_csv("D:/R_data_analyst/Google_specialization_R_Course/hotel_bookings.csv")
```
...
```{r}
swimming_pools <- read_csv("D:/R_data_analyst/Google_specialization_R_Course/swimming_pools.csv")
```
